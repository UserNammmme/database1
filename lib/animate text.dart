    ...
    <AnimatedTextExample>[
              ...
              children: <Widget>[
                ...
                DefaultTextStyle(
                  ...
                  child: AnimatedTextKit(
                    animatedTexts: [
                      RotateAnimatedText('Appbar'),
                      RotateAnimatedText('Coloumn'),
                      RotateAnimatedText(
                        'Row',
      ...
      AnimatedTextExample(
        ...
        child: DefaultTextStyle(
          ...
          child: AnimatedTextKit(
            animatedTexts: [
              FadeAnimatedText('yellow'),
              FadeAnimatedText('red'),
              FadeAnimatedText('green'),
            ],
            onTap: onTap,
          ),
        ),
        ...
        child: DefaultTextStyle(
          ...
          child: AnimatedTextKit(
            animatedTexts: [
              ...
              WavyAnimatedText('click'),
              WavyAnimatedText('move'),
            ],
            onTap: onTap,
          ),
        ),
        ...
        child: DefaultTextStyle(
          ...
          child: AnimatedTextKit(
            ...
            animatedTexts: [
              ...
              FlickerAnimatedText('name'),
              FlickerAnimatedText("widgets !"),
            ],
            onTap: onTap,
          ),
        ),
